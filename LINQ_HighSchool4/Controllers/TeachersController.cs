...
namespace LINQ_HighSchool4.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TeacherID,FirstName,LastName,PersonalNumber")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeacherID,FirstName,LastName,PersonalNumber")] Teacher teacher)
        {
